...
- (instancetype)init {
    if (self = [super init]) {
        ...
        [self bindKeyPaths: @[
            ...
            @keypath(self.publishPublicData),
            
            // loop mode
             
            @keypath(self.debugLoopMode),
            @keypath(self.debugLoopModeMaxTests),
            @keypath(self.debugLoopModeMinDelay),
            @keypath(self.debugLoopModeSkipQOS),
            ...
            @keypath(self.debugMapServerCustomizationEnabled),
            @keypath(self.debugMapServerHostname),
            @keypath(self.debugMapServerPort),
            @keypath(self.debugMapServerUseSSL),
